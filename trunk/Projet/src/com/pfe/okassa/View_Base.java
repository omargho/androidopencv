...
public abstract class View_Base extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public View_Base(Context context) {
        super(context);
	...
	public void run() {
        ...
        while (true) {
            ...
            if (bmp != null) {
            	 ...
            	 * carte m�moire il a fallut dans un premier temps 
